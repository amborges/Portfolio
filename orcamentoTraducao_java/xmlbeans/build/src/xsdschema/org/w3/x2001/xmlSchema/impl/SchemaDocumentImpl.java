...
public class SchemaDocumentImpl extends org.apache.xmlbeans.impl.values.XmlComplexContentImpl implements org.w3.x2001.xmlSchema.SchemaDocument
{
    ...
    public static class SchemaImpl extends org.w3.x2001.xmlSchema.impl.OpenAttrsImpl implements org.w3.x2001.xmlSchema.SchemaDocument.Schema
    {
         ...
         */
        public org.apache.xmlbeans.XmlNormalizedString xgetVersion()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.apache.xmlbeans.XmlNormalizedString target = null;
                target = (org.apache.xmlbeans.XmlNormalizedString)get_store().find_attribute_user(VERSION$24);
                return target;
            }
        }
         ...
         */
        public void xsetVersion(org.apache.xmlbeans.XmlNormalizedString version)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.apache.xmlbeans.XmlNormalizedString)get_store().add_attribute_user(VERSION$24);
                }
                target.set(version);
            }
        }
         ...
         */
        public org.w3.x2001.xmlSchema.DefaultDerivationSet xgetFinalDefault()
        {
            synchronized (monitor())
            {
                check_orphaned();
                org.w3.x2001.xmlSchema.DefaultDerivationSet target = null;
                target = (org.w3.x2001.xmlSchema.DefaultDerivationSet)get_store().find_attribute_user(FINALDEFAULT$26);
                if (target == null)
                {
                    target = (org.w3.x2001.xmlSchema.DefaultDerivationSet)get_default_attribute_value(FINALDEFAULT$26);
                }
                return target;
            }
        }
         ...
         */
        public void xsetFinalDefault(org.w3.x2001.xmlSchema.DefaultDerivationSet finalDefault)
        {
            synchronized (monitor())
            {
                check_orphaned();
                ...
                if (target == null)
                {
                    target = (org.w3.x2001.xmlSchema.DefaultDerivationSet)get_store().add_attribute_user(FINALDEFAULT$26);
                }
